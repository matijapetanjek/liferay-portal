...
public class BatchEngineBrokerTest {
	...
	public void testExportCompanyScopeObjectEntry() throws Exception {
		...
		BatchPlannerPlan batchPlannerPlan =
			_batchPlannerPlanLocalService.addBatchPlannerPlan(
				...
				RandomTestUtil.randomString(), 0, "C_MyObject", false);
	...
	private ObjectEntry _addObjectEntry(
		...
		return _objectEntryLocalService.addObjectEntry(
			...
			HashMapBuilder.<String, Serializable>put(
				"myAttachmentField", _getAttachmentFieldValue()
			).put(
				"myBooleanField", RandomTestUtil.randomBoolean()
			).put(
				"myDateField", "2022-01-01"
			).put(
				"myDateTimeField", "2023-07-27T12:00:00.000Z"
			).put(
				"myDecimalField", 7.5
			).put(
				"myIntegerField", RandomTestUtil.randomInt()
			).put(
				"myLongIntegerField", 123456789L
			).put(
				"myLongTextField", RandomTestUtil.randomString()
			).put(
				"myMultiselectPicklistField",
				"listTypeEntryKey1, listTypeEntryKey2"
			).put(
				"myPicklistField", "listTypeEntryKey1"
			).put(
				"myPrecisionDecimalField",
				new BigDecimal(0.1234567891234567, MathContext.DECIMAL64)
			).put(
				"myRichTextField",
				"<p>My text</p><p><img alt=\\\"\\\" height=\\\"202\\\" src=" +
					"\\\"http://localhost:8080/image/company_logo?\\\"><br></p>"
			).put(
				"myTextField", RandomTestUtil.randomString()
			).build(),
	...
	private static final List<String> _fieldNames = Arrays.asList(
		...
		"myAttachmentField", "myBooleanField", "myDateField", "myDateTimeField",
		"myDecimalField", "myIntegerField", "myLongIntegerField",
		"myLongTextField", "myMultiselectPicklistField", "myPicklistField",
		"myPrecisionDecimalField", "myRichTextField", "myTextField");
